...
public class signinpage {
	...
	public void user_launch_the_Firefox_browser() {
		System.setProperty("webdriver.gecko.driver","C:\\Users\\hp\\Documents\\Desktop\\Hybrid\\cucumber\\drivers\\geckodriver.exe");
	...
	public void user_enters_email_as_and_password_as(String string, String string2) throws InterruptedException {
	   s.email1().sendKeys("dagurkapil2@gmail.com");
	   Thread.sleep(3000);
	   s.pwd1().sendKeys("Kapil@12345");
	}
	@And("click on signup")
